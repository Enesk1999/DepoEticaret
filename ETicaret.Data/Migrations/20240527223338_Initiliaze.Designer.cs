...
namespace ETicaret.Data.Migrations
{
    ...
    [Migration("20240527223338_Initiliaze")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ETicaret.Model.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ETicaret.Model.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ETicaret.Model.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ETicaret.Model.Models.OrderDetail", b =>
                {
                    b.HasOne("ETicaret.Model.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ETicaret.Model.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("ETicaret.Model.Models.OrderHeader", b =>
                {
                    b.HasOne("ETicaret.Model.Models.AppUser", "AppUser")
                        .WithMany()
